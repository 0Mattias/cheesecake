...
- **build** compiles the mod and the test harness, runs the unit tests and checks the jar: no stub classes, no test harness, remapped to intermediary, version substituted, icon present.
