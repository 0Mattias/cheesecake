...
public final class InputOverrideHandler extends Behavior implements IInputOverrideHandler {
    ...
    public InputOverrideHandler(Cheesecake cheesecake) {
        super(cheesecake);
        this.blockBreakHelper = new BlockBreakHelper(cheesecake.getPlayerContext());
        this.blockPlaceHelper = new BlockPlaceHelper(cheesecake.getPlayerContext());
    }
    ...
    private boolean inControl() {
        ...
        return cheesecake.getPathingBehavior().isPathing() || cheesecake != CheesecakeAPI.getProvider().getPrimaryCheesecake();
    }
