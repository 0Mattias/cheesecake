...
public abstract class Movement implements IMovement, MovementHelper {
    ...
    protected final ICheesecake cheesecake;
    ...
    protected Movement(ICheesecake cheesecake, BetterBlockPos src, BetterBlockPos dest, BetterBlockPos[] toBreak, BetterBlockPos toPlace) {
    ...
    protected Movement(ICheesecake cheesecake, BetterBlockPos src, BetterBlockPos dest, BetterBlockPos[] toBreak) {
        this(cheesecake, src, dest, toBreak, null);
    }
    ...
    protected boolean playerInValidPosition() {
        return getValidPositions().contains(ctx.playerFeet()) || getValidPositions().contains(((PathingBehavior) cheesecake.getPathingBehavior()).pathStart());
    }
    ...
    public MovementStatus update() {
        ...
        currentState.getTarget().getRotation().ifPresent(rotation ->
                cheesecake.getLookBehavior().updateTarget(
                        rotation,
                        currentState.getTarget().hasToForceRotations()));
        cheesecake.getInputOverrideHandler().clearAllKeys();
        currentState.getInputStates().forEach((input, forced) -> {
            cheesecake.getInputOverrideHandler().setInputForceState(input, forced);
        });
