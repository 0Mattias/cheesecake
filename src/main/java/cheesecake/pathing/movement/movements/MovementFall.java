...
import cheesecake.api.utils.VecUtils;
...
public class MovementFall extends Movement {
    ...
    public MovementFall(ICheesecake cheesecake, BetterBlockPos src, BetterBlockPos dest) {
        super(cheesecake, src, dest, MovementFall.buildPositionsToBreak(src, dest));
    }
...
//         Block destBlock = destState.getBlock();
        ...
        if (playerFeet.equals(dest) && (ctx.player().getY() - playerFeet.getY() < 0.094 || isWater)) { // 0.094
                                                                                                                // because
                                                                                                                // lilypads
        ...
        if (avoid == null) {
            ...
            double dist = Math.abs(avoid.getX() * (destCenter.x - avoid.getX() / 2.0 - ctx.player().getX()))
