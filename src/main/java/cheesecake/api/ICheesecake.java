...
import cheesecake.api.process.*;
import cheesecake.api.selection.ISelectionManager;
import cheesecake.api.utils.IInputOverrideHandler;
...
public interface ICheesecake {
    ...
    /**
     * Returns the {@link IPathingControlManager} for this {@link ICheesecake} instance, which is responsible
     * for managing the {@link ICheesecakeProcess}es which control the {@link IPathingBehavior} state.
     *
