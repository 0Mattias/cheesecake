...
package cheesecake.api.command.registry;
 ...
 * ones. In Cheesecake, this is used for commands and argument parsers so that mods and addons can extend Cheesecake's
