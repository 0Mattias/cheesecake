 ...
 * <p>
 * Differences between a cheesecake process and a behavior:
 * <ul>
 * <li>Only one cheesecake process can be active at a time</li>
 ...
 * @author leijurv
 */
public interface ICheesecakeProcess {
    ...
    /**
     * Called when this process is in control of pathing; Returns what Cheesecake should do.
     *
