...
import cheesecake.api.cache.ICachedRegion;
...
public final class CachedRegion implements ICachedRegion {
    ...
    /**
     * Magic value to detect invalid cache files, or incompatible cache files saved in an old version of Cheesecake
     */
    ...
    public synchronized final void removeExpired() {
        long expiry = Cheesecake.settings().cachedChunksExpirySeconds.value;
        if (expiry < 0) {
            return;
        }
