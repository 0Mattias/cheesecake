...
import cheesecake.api.utils.BlockUtils;
...
public final class CachedChunk {
    ...
    CachedChunk(int x, int z, int height, BitSet data, BlockState[] overview,
            Map<String, List<BlockPos>> specialBlockLocations, long cacheTimestamp) {
    ...
    public final BlockState getBlock(int x, int y, int z, DimensionType dimension) {
        ...
        if (heightMap[internalPos] == y && type != PathingBlockType.AVOID) {
             ...
             * if (!Minecraft.getInstance().world.getBlockState(new BlockPos(x + this.x *
             * 16, y, z + this.z * 16)).getBlock().equals(state.getBlock())) {
             * throw new IllegalStateException("failed " +
             * Minecraft.getInstance().world.getBlockState(new BlockPos(x + this.x * 16, y,
