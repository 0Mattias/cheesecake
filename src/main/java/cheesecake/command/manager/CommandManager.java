...
package cheesecake.command.manager;
...
import cheesecake.api.command.exception.CommandUnhandledException;
import cheesecake.api.command.exception.ICommandException;
...
import cheesecake.command.defaults.DefaultCommands;
...
public class CommandManager implements ICommandManager {
    ...
    public CommandManager(Cheesecake cheesecake) {
        this.cheesecake = cheesecake;
        DefaultCommands.createAll(cheesecake).forEach(this.registry::register);
    }

    @Override
    public ICheesecake getCheesecake() {
