...
package cheesecake.command.argument;
...
import cheesecake.api.command.datatypes.IDatatype;
import cheesecake.api.command.datatypes.IDatatypeContext;
import cheesecake.api.command.datatypes.IDatatypeFor;
import cheesecake.api.command.datatypes.IDatatypePost;
...
import cheesecake.api.command.exception.CommandTooManyArgumentsException;
...
public class ArgConsumer implements IArgConsumer {
    ...
    public <T, O, D extends IDatatypePost<T, O>> T getDatatypePost(D datatype, O original) throws CommandInvalidTypeException, CommandNotEnoughArgumentsException {
        try {
            ...
            if (Cheesecake.settings().verboseCommandExceptions.value) {
                e.printStackTrace();
            }
    ...
    private final class Context implements IDatatypeContext {
        ...
        public final ICheesecake getCheesecake() {
            return ArgConsumer.this.manager.getCheesecake();
        }
