...
public class SaveAllCommand extends Command {
    ...
    public SaveAllCommand(ICheesecake cheesecake) {
        super(cheesecake, "saveall");
    }
    ...
    public String getShortDesc() {
        return "Saves Cheesecake's cache for this world";
    }

    @Override
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The saveall command saves Cheesecake's world cache.",
                "",
                "Usage:",
                "> saveall"
        );
