...
public class HelpCommand extends Command {
    ...
    public HelpCommand(ICheesecake cheesecake) {
        super(cheesecake, "help", "?");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        if (!args.hasAny() || args.is(Integer.class)) {
            Paginator.paginate(
                    args, new Paginator<>(
                            this.cheesecake.getCommandManager().getRegistry().descendingStream()
                                    .filter(command -> !command.hiddenFromHelp())
                                    .collect(Collectors.toList())),
                    () -> logDirect("All Cheesecake commands (clickable):"),
                    command -> {
            ...
            ICommand command = this.cheesecake.getCommandManager().getCommand(commandName);
            if (command == null) {
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "Using this command, you can view detailed help information on how to use certain commands of Cheesecake.",
                "",
                "Usage:",
