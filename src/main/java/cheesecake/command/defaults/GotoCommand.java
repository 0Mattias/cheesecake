...
import cheesecake.api.command.datatypes.RelativeCoordinate;
import cheesecake.api.command.datatypes.RelativeGoal;
...
public class GotoCommand extends Command {
    ...
    protected GotoCommand(ICheesecake cheesecake) {
        super(cheesecake, "goto");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        cheesecake.getGetToBlockProcess().getToBlock(destination);
    }
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The goto command tells Cheesecake to head towards a given goal or block.",
                "",
