...
import cheesecake.api.command.datatypes.EntityClassById;
import cheesecake.api.command.datatypes.IDatatypeFor;
import cheesecake.api.command.datatypes.NearbyPlayer;
import cheesecake.api.command.exception.CommandErrorMessageException;
...
public class FollowCommand extends Command {
    ...
    public FollowCommand(ICheesecake cheesecake) {
        super(cheesecake, "follow");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        if (args.hasExactlyOne()) {
            cheesecake.getFollowProcess().follow((group = args.getEnum(FollowGroup.class)).filter);
        } else {
            args.requireMin(2);
            group = null;
            ...
            cheesecake.getFollowProcess().follow(
                    classes.isEmpty()
                            ? entities::contains
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The follow command tells Cheesecake to follow certain kinds of entities.",
                "",
                "Usage:",
