...
public class ReloadAllCommand extends Command {
    ...
    public ReloadAllCommand(ICheesecake cheesecake) {
        super(cheesecake, "reloadall");
    }
    ...
    public String getShortDesc() {
        return "Reloads Cheesecake's cache for this world";
    }

    @Override
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The reloadall command reloads Cheesecake's world cache.",
                "",
                "Usage:",
                "> reloadall"
        );
