...
import cheesecake.api.command.datatypes.RelativeGoalXZ;
...
public class ExploreCommand extends Command {
    ...
    public ExploreCommand(ICheesecake cheesecake) {
        super(cheesecake, "explore");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        cheesecake.getExploreProcess().explore(goal.getX(), goal.getZ());
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "Tell Cheesecake to explore randomly. If you used explorefilter before this, it will be applied.",
                "",
                "Usage:",
