...
public class ExploreFilterCommand extends Command {
    ...
    public ExploreFilterCommand(ICheesecake cheesecake) {
        super(cheesecake, "explorefilter");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        try {
            cheesecake.getExploreProcess().applyJsonFilter(file.toPath().toAbsolutePath(), invert);
