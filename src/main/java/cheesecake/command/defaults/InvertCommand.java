...
import cheesecake.api.pathing.goals.GoalInverted;
...
public class InvertCommand extends Command {
    ...
    public InvertCommand(ICheesecake cheesecake) {
        super(cheesecake, "invert");
    }

    @Override
    public void execute(String label, IArgConsumer args) throws CommandException {
        args.requireMax(0);
        ICustomGoalProcess customGoalProcess = cheesecake.getCustomGoalProcess();
        Goal goal;
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The invert command tells Cheesecake to head away from the current goal rather than towards it.",
                "",
                "Usage:",
