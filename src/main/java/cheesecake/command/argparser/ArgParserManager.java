...
package cheesecake.command.argparser;

import cheesecake.api.command.argparser.IArgParser;
import cheesecake.api.command.argparser.IArgParserManager;
...
import cheesecake.api.command.exception.CommandNoParserForTypeException;
