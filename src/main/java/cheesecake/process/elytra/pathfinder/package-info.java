 ...
 * over a few hundred generated chunks and a few thousand rays. The only Minecraft in here is
 * BlockPos, Direction, Vec3 and Mth; the seam is
 * {@link cheesecake.process.elytra.NetherPathfinderContext}, which packs the game's chunks into
 * {@link cheesecake.process.elytra.pathfinder.Chunk}s and asks
